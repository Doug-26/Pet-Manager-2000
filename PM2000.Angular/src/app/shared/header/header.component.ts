      ...
      <div class="mx-auto flex max-w-7xl items-center gap-3 px-6 py-4">
        ...
        <div class="ml-auto flex items-center gap-3">
          ...
          @if (displayOpen()) {
            <button
              type="button"
              class="flex items-center gap-1.5 rounded-lg bg-red-50 px-3 py-1.5 text-sm font-medium text-red-600 transition-colors hover:bg-red-100 focus:outline-none focus:ring-2 focus:ring-red-400 focus:ring-offset-1"
            ...
            <button
              type="button"
              class="flex items-center gap-1.5 rounded-lg bg-slate-100 px-3 py-1.5 text-sm font-medium text-slate-600 transition-colors hover:bg-slate-200 focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-1"
